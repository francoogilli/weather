  ...
  return (
    <SectionContainer className={'py-0 pb-32 text-center grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 font-semibold text-3xl sm:text-4xl text-white items-center justify-center'}>
      <div  className='flex flex-col gap-y-4 bg-[#3b545c38] items-start border border-[#ffffff19] shadow-2xl rounded-3xl px-5 sm:px-9 py-5 '>
        ...
        <p className='text-white font-extrabold text-3xl sm:text-5xl '>{formatTime(sunrise)}<span className='text-xl sm:text-3xl'> AM</span></p>
        <p className='text-sm font-normal text-white text-left pt-5'>Sunset: {formatTime(sunset)} AM</p>
      </div>
      ...
      <div  className='flex flex-col gap-y-4 bg-[#3b545c38] items-start border border-[#ffffff19] shadow-2xl rounded-3xl px-5 sm:px-9 py-5 '>
        ...
        <p className='text-sm font-normal text-white text-left'>The wind direction is {convertDir(winddir)}.</p>
      </div>
      ...
      <div  className='flex flex-col gap-y-4 bg-[#3b545c38] items-start border border-[#ffffff19] shadow-2xl rounded-3xl px-5 sm:px-10 py-5 '>
        ...
        <p className='text-white font-extrabold text-4xl sm:text-5xl'>{Math.floor(pressure)} <span className='text-lg sm:text-3xl'>hPa</span></p>
      ...
      <div  className='flex flex-col gap-y-4 bg-[#3b545c38] items-start border border-[#ffffff19] shadow-2xl rounded-3xl px-5 sm:px-10 py-5 '>
        ...
        <p className='text-white font-extrabold text-4xl sm:text-5xl'>{snow} <span className='text-xl sm:text-3xl'>cm</span></p>
        </div>
        <p className='text-sm font-normal text-white text-left'>The snow depth is around {Math.floor(snowdepth)} cm.</p>
      </div>
    </SectionContainer>
  );
};
