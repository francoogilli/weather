...
const DataMain = () => {
  return (
    <SectionContainer className={'py-10 pb-32 text-center grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 font-semibold text-4xl text-white items-center justify-center'}>
