...
const Forecast = () => {
    ...
    return (
      <SectionContainer className={' font-base text-base text-white overflow-auto'}>
        <div>
          <div className="flex flex-row gap-3">
            {hoursArray.map((hour, index) => {
              return (
                <div className="border border-white/20 gap-y-5 flex flex-col items-center rounded-full py-2 px-2.5" key={index}>
                  <p className="pt-1">{hour.hour}</p>
                  <p>{hour.icon}</p>
                  <p>{hour.temp}</p>
                </div>
              );
